How to contribute to Cozy cozy-store?
====================================
...
- What is the version of the Cozy cozy-store?
...
```
$ git clone github.com/cozy/cozy-store.git
$ cd cozy-store
$ git remote add fork git://github.com/yourusername/cozy-store.git
```
...
Go to https://github.com/yourusername/cozy-store and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy cozy-store is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-store/issues/new
